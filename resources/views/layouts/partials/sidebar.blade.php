            ...
            */ ?> 
               ...
               <li class="treeview">
                     ...
                     @endpermission
                      ...
                      @permission('viewTelaCoordenadorColegiado')
                     ...
                     @endpermission
                      ...
                      @permission('viewTelaCoordenadorArea')
                      ...
                      @endpermission
                       ...
                       @permission('viewTelaSecretarioDepartamento')
                     ...
                     @endpermission
                      ...
                      @permission('viewTelaCoordenadorDepartamento')
